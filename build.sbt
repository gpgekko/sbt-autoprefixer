...
libraryDependencies ++= Seq(
   "org.webjars.npm" % "autoprefixer" % "7.1.6" exclude("org.webjars.npm", "browserslist")
                                                exclude("org.webjars.npm", "electron-to-chromium"),
   ...
   "org.webjars.npm" % "block-stream" % "0.0.9" exclude("org.webjars.npm", "glob")
                                                exclude("org.webjars.npm", "inherits"),
   ...
   "org.webjars.npm" % "browserslist" % "2.11.2" exclude("org.webjars.npm", "caniuse-lite"),
   ...
   "org.webjars.npm" % "readdirp" % "2.1.0" exclude("org.webjars.npm", "process-nextick-args")
                                            exclude("org.webjars.npm", "inherits") 
                                            exclude("org.webjars.npm", "graceful-fs"),
   "org.webjars.npm" % "anymatch" % "1.3.2" exclude("org.webjars.npm", "micromatch"),
   "org.webjars.npm" % "chokidar" % "1.7.0" exclude("org.webjars.npm", "glob") 
                                            exclude("org.webjars.npm", "inherits") 
                                            exclude("org.webjars.npm", "anymatch") 
                                            exclude("org.webjars.npm", "readdirp")
)
...
dependencyOverrides += "org.webjars.npm" % "browserslist" % "2.11.2" exclude("org.webjars.npm", "caniuse-lite")
